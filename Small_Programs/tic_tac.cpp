...
int main(){
    int grid[100][100] = {0};
    int n;
    cout<<"Enter grid dimension"<<endl;
    cin>>n;
    ...
    /*
        ...
        We will create a single arraywith the 2N+2 needed verifications
        ...
        To verify the right diagonal:we start from the last cell in first row (0,n-1 ) and moves
        1 means move to next row, 01 means move to the previous column
      ...
      */
      ...
      //Add col n postions to verify
      for(int c= 0;c<n;++c)
        rs[verify] = 0 , cs[verify ] = c , dr[verify] = 0, dc[verify++] = 0;
